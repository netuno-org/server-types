...
import ScriptResult from '../objects/ScriptResult';
...
interface Exec {
	...
	afterClose: {
		(func: java.util.function.Function): void;
	}
	as: {
		(o: java.lang.Object): Values;
	...
	bind: {
		(key: string, value: java.lang.Object): Exec;
	}
	cj: {
		(id: string, code: string): ScriptResult;
		(id: string, code: string, bindings: Values): ScriptResult;
	}
	clear: {
		(): void;
	}
	...
	functions: {
		(): Functions;
		(functions: java.util.function.Function[]): Functions;
		(data: java.lang.Object): Functions;
		(data: java.lang.Object, functions: java.util.function.Function[]): Functions;
	}
	gc: {
		(): void;
	}
	...
	service: {
		(path: string): ScriptResult;
		(path: string, preserveContext: boolean): ScriptResult;
	}
	set: {
		(index: int, element: java.lang.Object): Values;
		(key: string, value: java.lang.Object): Values;
